                    ...
                    <div class="card-body px-5">
                         ...
                         <form action="" method="post" class="row">
                              <div class="col-12 col-sm-6">
                                   ...
                                   <input type="text" vali class="form-control" name="firstname" placeholder="Họ và tên đệm" value='<?php echo @$_SESSION['user']['ho'] ?>' required>
                                   <label mess="firstname"></label>
                              </div>
                              <div class="col-12 col-sm-6">
                                   <label class="form-label">Tên</label>
                                   <input type="text" vali class="form-control" name="lastname" placeholder="Tên" value='<?php echo @$_SESSION['user']['ten'] ?>' required>
                                   <label mess="lastname"></label>
                              </div>
                              <div>
                                   <label class="form-label">Phone</label>
                                   <input type="text" vali class="form-control" name="phone" placeholder="Số điện thoại" value='<?php echo @$_SESSION['user']['sdt'] ?>'>
                                   <label mess="phone"></label>
                              </div>
                              <div>
                                   <label class="form-label">Email</label>
                                   <input type="email" vali class="form-control" name="email" placeholder="Email" value='<?php echo @$_SESSION['user']['email'] ?>'>
