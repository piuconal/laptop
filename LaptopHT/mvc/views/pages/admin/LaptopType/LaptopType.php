...
echo "<table align='center' class='table table-bordered table-striped' cellpadding='2' cellspacing='2'>
          <tr align='center' class='table-primary' style='font-size:20px'>
...
foreach ($data['dType'] as $key => $value){
     ...
     echo "<tr align='center'>
               ...
               <td>
                    <a href='$data[domain]/Admin/$data[controller]/Edit/$value[ID_Type]'><i class='bi bi-pencil-square btn btn-success rounded-circle shadow-lg' style='color:white; font-size: 20px;'></i></a>
                    <a href='$data[domain]/Admin/$data[controller]/Delete/$value[ID_Type]'><i class='bi bi-trash-fill btn btn-danger rounded-circle shadow-lg' style='color:white; font-size: 20px;'></i></a>               
               </td>
          </tr>";
}
echo "</table>";
